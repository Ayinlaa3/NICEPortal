    ...
    <header className="bg-[--accent] border-b border-[--border]">
      <div className="px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <h1 className="font-[Old_English_Text_MT_V2] text-[--primary] text-2xl leading-tight">
            NICE Membership Portal
          </h1>
        </div>
          ...
          <div className="flex items-center gap-4">
            {user?.role === "member" && (
              <>
                ...
                <Link to="/uploads" className="text-lg font-medium">Uploads</Link>
              </>
            )}
            {user?.role === "admin" && (
              <>
                <Link to="/admin" className="text-lg font-medium">Admin Panel</Link>
                <Link to="/admin/reports" className="text-lg font-medium">Reports</Link>
              </>
            )}
