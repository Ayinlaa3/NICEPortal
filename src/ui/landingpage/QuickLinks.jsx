...
const QuickLinks = () => {
  ...
  return (
    <section className="relative p-6 bg-[linear-gradient(121.26deg,_#03823B_31.11%,_#5EA13D_58.82%,_#B6EA60_86.53%)] h-[267px]">
      <h2 className="text-white text-xl font-bold text-center mb-6">
        Quick Links
      </h2>

      <div className="absolute left-1/2 -translate-x-1/2 w-8/10">
        ...
        <div className="bg-green-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 rounded-b-xl">
          ...
          <Button type="tertiary">Donate Now</Button>
        </div>
      </div>
    </section>
  );
